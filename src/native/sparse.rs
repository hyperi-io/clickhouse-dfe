...
mod tests {
    ...
    #[tokio::test]
    async fn test_read_sparse_offsets_simple() {
        ...
        let mut bytes = std::io::Cursor::new(data);
        let mut state = SparseDeserializeState::default();
        let offsets = read_sparse_offsets(&mut bytes, 8, &mut state)
            .await
            .unwrap();
    ...
    #[tokio::test]
    async fn test_read_sparse_offsets_all_defaults() {
        let mut data = Vec::new();
        data.extend(encode_var_uint(4 | END_OF_GRANULE_FLAG));

        let mut bytes = std::io::Cursor::new(data);
        let mut state = SparseDeserializeState::default();
        let offsets = read_sparse_offsets(&mut bytes, 4, &mut state)
            .await
            .unwrap();
    ...
    #[tokio::test]
    async fn test_read_sparse_offsets_no_defaults() {
        ...
        let mut bytes = std::io::Cursor::new(data);
        let mut state = SparseDeserializeState::default();
        let offsets = read_sparse_offsets(&mut bytes, 3, &mut state)
            .await
            .unwrap();
    ...
    #[tokio::test]
    async fn test_read_sparse_offsets_first_is_value() {
    ...
    #[tokio::test]
    async fn test_single_row_default() {
        ...
        let mut bytes = std::io::Cursor::new(data);
        let mut state = SparseDeserializeState::default();
        let offsets = read_sparse_offsets(&mut bytes, 1, &mut state)
            .await
            .unwrap();
    ...
    #[tokio::test]
    async fn test_single_row_non_default() {
    ...
    #[tokio::test]
    async fn test_large_gap_value_at_end() {
        ...
        let mut bytes = std::io::Cursor::new(data);
        let mut state = SparseDeserializeState::default();
        let offsets = read_sparse_offsets(&mut bytes, 1000, &mut state)
            .await
            .unwrap();
    ...
    #[tokio::test]
    async fn test_value_at_position_zero_only() {
        ...
        let mut bytes = std::io::Cursor::new(data);
        let mut state = SparseDeserializeState::default();
        let offsets = read_sparse_offsets(&mut bytes, 100, &mut state)
            .await
            .unwrap();
    ...
    #[tokio::test]
    async fn test_consecutive_non_defaults() {
        ...
        let mut bytes = std::io::Cursor::new(data);
        let mut state = SparseDeserializeState::default();
        let offsets = read_sparse_offsets(&mut bytes, 6, &mut state)
            .await
            .unwrap();
    ...
    #[tokio::test]
    async fn test_state_carry_trailing_defaults() {
