...
If the issue is in the official ClickHouse Rust client rather than in this
crate's own code, please report it to
[ClickHouse/clickhouse-rs](https://github.com/ClickHouse/clickhouse-rs) as
well. Tell us either way and we will coordinate.
...
- Missing security headers or TLS configuration issues that are not
